local Tree = require("gittools.util.Tree")
local uitool = require("gittools.util.uitool")
local Signal = require("gittools.util.Signal")
...
---@alias keystone.util.TreeBuffer.FormatterFn fun(id:any, data:any, expanded:boolean):string[][], string[][]
